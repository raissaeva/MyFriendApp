package com.example.myfriendapp
    ...
    class MyFriendsAddFragment : Fragment() {
        ...
        private fun initLocalDB() { db = AppDatabase.getAppDataBase(activity!!)
            myFriendDao = db?.myFriendDao() }

        private fun initView() { btnSave.setOnClickListener { validasiInput() }
        ...
        private fun validasiInput() { namaInput = edtName.text.toString()
            ...
            when{ namaInput.isEmpty() -> edtName.error = "Nama tidak boleh kosong"
                ...
                alamatInput.isEmpty() -> edtAddress.error = "Alamat tidak boleh kosong"
                    ...
                    val teman = MyFriend(
                        ...
                        email = emailInput,
                        telp = telpInput,
                        alamat = alamatInput) tambahDataTeman(teman)
